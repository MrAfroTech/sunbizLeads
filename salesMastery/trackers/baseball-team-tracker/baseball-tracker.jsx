...
/** Full list (imports). UI reads/writes the *_ui tables (subset, no scraped CSV teams). */
const TEAMS_MASTER_TABLE = "baseball_teams";
const TEAMS_UI_TABLE = "baseball_teams_ui";
const CONTACTS_UI_TABLE = "baseball_team_contacts_ui";
...
export default function BaseballTracker() {
  ...
  const loadRecords = useCallback(async () => {
    ...
    console.log("[Tracker] Load raw baseball_teams_ui response:", {
  ...
  const handleFile = useCallback(async (file) => {
    ...
    // Upsert only mutable identity/profile fields so existing
    // outreach + checkbox states remain unchanged.
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = "baseball-team-tracker.csv";
    a.click();
        ...
        {loading ? (
          ...
          <div>
            <div
              ...
              onDrop={handleDrop}
              onClick={() => document.getElementById("bt-csv-input").click()}
              style={{
            ...
            >
              ...
              <div style={{ fontSize: 14, color: "#888888", marginBottom: 8 }}>
                Drop your CSV here (columns: <strong style={{ color: "#888888" }}>tier</strong>, <strong style={{ color: "#888888" }}>league</strong>, <strong style={{ color: "#888888" }}>team_name</strong>, <strong style={{ color: "#888888" }}>website</strong>)
              </div>
              <div
                style={{
