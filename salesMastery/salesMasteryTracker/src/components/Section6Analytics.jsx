...
const COLORS = ['#d4af37', '#e0b841', '#f5d76e', '#b8860b', '#8b7355'];
const LABELS = ['LinkedIn', 'Cold Calls', 'Walk-Ins', 'Networking', 'Email Prospecting'];
...
function Section6Analytics({ formStateWithConv }) {
  ...
  const s5Emails = num(formStateWithConv.s5Emails);
  ...
  const s5Demos = num(formStateWithConv.s5Demos);
  ...
  const s5Sales = num(formStateWithConv.s5Sales);
    ...
    datasets: [
      {
        ...
        data: [s1Requests, s2Calls, s3Walkins, s4Contacts, s5Emails],
    ...
    datasets: [
      {
        ...
        data: [s1Demos, s2Demos, s3Demos, s4Demos, s5Demos],
        backgroundColor: COLORS,
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        data: [s1Sales, s2Sales, s3Sales, s4Sales, s5Sales],
        backgroundColor: COLORS,
      },
    ],
  };
  ...
  return (
    <section style={{ marginBottom: 32, border: '1px solid var(--section-border)', padding: 16, borderRadius: 'var(--section-radius)', background: 'var(--section-bg)' }}>
      <h2 style={{ marginTop: 0 }}>Section 6: Visual Analytics (Auto-Generated)</h2>
      <div
        style={{
          display: 'grid',
...
export default Section6Analytics;
