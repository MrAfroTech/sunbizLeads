/**
 * Import Event_Planner.csv into public.event_directors (salesMastery Supabase).
 *
 * Run from playwrightAutomation:
 *   node scripts/import-event-planners.js [path/to/Event_Planner.csv]
 */
