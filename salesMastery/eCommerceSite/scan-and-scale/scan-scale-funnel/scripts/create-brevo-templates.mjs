 ...
 *     Defaults to ../../../../emailSequences/scanAndScaleSequence relative to this script
 *     (repo: salesMastery/emailSequences/scanAndScaleSequence).
 */
...
const SPECS = [
  {
    file: 'scan_scale_email_001.html',
    templateName: 'Scan & Scale — Email 1: The Mirror',
    subject: 'Your concession lines are deciding how much your fans spend.',
    key: 'email_1_template_id',
  },
  {
    file: 'scan_scale_email_002.html',
    templateName: 'Scan & Scale — Email 2: The Proof',
    subject:
      'Semi-pro venues using this saw 34% more revenue. Same roster. Same stadium.',
    key: 'email_2_template_id',
  },
  {
    file: 'scan_scale_email_003.html',
    templateName: 'Scan & Scale — Email 3: The Cost of Waiting',
    subject: "You have 20 home games. Every one without this is money you won't get back.",
    key: 'email_3_template_id',
  },
  {
    file: 'scan_scale_email_004.html',
    templateName: 'Scan & Scale — Email 4: The Decision',
    subject:
      'One 30-minute call. Your fastest path to ROI before your next home game.',
...
async function main() {
  ...
  const tplRoot =
    ...
    path.resolve(__dirname, '../../../../emailSequences/scanAndScaleSequence');
