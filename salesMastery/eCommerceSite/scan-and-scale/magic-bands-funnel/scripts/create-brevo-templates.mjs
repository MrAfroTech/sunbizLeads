#!/usr/bin/env node
/**
 * Creates the four MagicBands Brevo SMTP templates via POST /v3/smtp/templates
 ...
 *
 * Optional:
 *   SCAN_SCALE_EMAIL_TEMPLATE_DIR — absolute folder containing magic_bands_email_00{N}.html
