/**
 * Self-contained submit-lead for tier3-revenue-dominance (and standard pattern for landing pages).
 * POST /api/submit-lead
 * Body: { name, email, phone?, consent_sms, consent_promo }
 * Uses Brevo: contact + template email. Set BREVO_API_KEY, BREVO_LIST_ID, BREVO_TEMPLATE_ID in Vercel.
 */
