...
const BusinessQualificationFlow = ({ onOpenFunnel }) => {
  ...
  return (
    <section className="bqf-hero">
      <div className="bqf-container">
        {/* Step 1: Business Type */}
        {step === 1 && (
          <div className="bqf-step bqf-step-1">
            <h2 className="bqf-title">Smarter Systems Leading To Better Experiences For All</h2>
            <p className="bqf-description">Seamlessly transforms hospitality by connecting guests, vendors, and venues through a single, cohesive platform. Minimizing long lines, reducing staff overwhelm, and unifying ticketing, POS, reservations, and delivery; we increase revenue, improve retention, and optimize operations. Our mission is to create an immersive, frictionless experiences that delight customers. While empowering venues to operate smarter, faster, and more profitably.</p>
