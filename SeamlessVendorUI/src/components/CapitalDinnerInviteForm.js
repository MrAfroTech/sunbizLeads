...
const CapitalDinnerInviteForm = ({ isOpen, onClose, audience }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Reset form state each time modal opens so user gets a fresh form
      setFormData({
        fullName: '',
        email: '',
        companyOrFundName: '',
  ...
  return (
    ...
    >
      <div
        className="popup-container capital-dinner-form"
        onClick={(e) => e.stopPropagation()}
        role="dialog"
        aria-modal="true"
        aria-labelledby="capital-dinner-form-title"
        aria-describedby={submitted ? 'capital-dinner-success-desc' : 'capital-dinner-form-desc'}
      >
        <button
          type="button"
        ...
        {submitted ? (
          <div className="thank-you-message" id="capital-dinner-success-desc">
          ...
          <div className="popup-content">
            <div className="popup-header">
              <h3 id="capital-dinner-form-title" className="popup-title">Request an Invitation</h3>
              <p id="capital-dinner-form-desc" className="popup-subtitle">
