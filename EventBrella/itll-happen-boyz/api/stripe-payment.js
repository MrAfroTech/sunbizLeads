...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Validate tier (Summer Showcase 2026: day-pass, weekend-pass, vip-day-pass, vip-weekend-pass)
    const validTiers = ['day-pass', 'weekend-pass', 'vip-day-pass', 'vip-weekend-pass'];
    ...
    const tierPrices = {
      'day-pass': 2000,        // $20
      'weekend-pass': 5200,    // $52
      'vip-day-pass': 6000,    // $60
      'vip-weekend-pass': 15200 // $152
    };
    ...
    const tierNames = { 'day-pass': 'Day Pass', 'weekend-pass': 'Weekend Pass', 'vip-day-pass': 'VIP Day Pass', 'vip-weekend-pass': 'VIP Weekend Pass' };
    const ticketName = eventName ? `${eventName} - ${tierNames[tier] || tier}` : `Summer Showcase 2026 - ${tierNames[tier] || tier}`;
