// Farm Tours Page - Only shows Monthly Farm Tour events
...
function renderEvents() {
    ...
    const monthlyDescription = 'Summer Showcase 2026. January 26-28. Central Florida.';
    monthlyCard.innerHTML = `
        <div class="event-tooltip">${monthlyDescription}</div>
        <div class="event-name">Summer Showcase 2026</div>
        <div class="event-time">9:00 AM - 11:00 AM EST</div>
        <div class="event-venue">TBA</div>
