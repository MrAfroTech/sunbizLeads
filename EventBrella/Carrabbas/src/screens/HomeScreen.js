...
export default function HomeScreen({ navigation }) {
  const merchOfTheDay = mockMerch.find(item => item.featured) || mockMerch[0];
      ...
      <View style={styles.section}>
        <Card style={styles.fullWidthCard}>
          <View style={styles.merchHeader}>
            <Text style={styles.merchTitle}>MERCH OF THE DAY</Text>
          ...
          <View style={styles.merchContent}>
            ...
            <Text style={styles.merchItem}>{merchOfTheDay.name}</Text>
...
const styles = StyleSheet.create({
  ...
  fullWidthCard: {
    marginHorizontal: -8, // Full-width card (extends to page edges)
  },
  sectionTitle: {
    fontSize: Typography.fontSize.h4,
    fontWeight: Typography.fontWeight.heavy,
  ...
  badge: {
    ...
    borderRadius: 0, // Badges completely sharp (0-2px)
    borderWidth: 2,
