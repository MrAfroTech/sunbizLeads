...
2. **Select your project** (strikeAfterDark)
...
3. **Create new project**:
   - Project name: `strikeafterdark` (or whatever you want)
...
If you want to test locally, create a `.env` file in the `strikeAfterDark` folder:

```bash
DATABASE_URL=postgresql://user:password@localhost:5432/strikeafterdark
```
