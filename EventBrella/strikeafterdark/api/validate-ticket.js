...
const { getTicketByTicketId, getTransactionStatus, markTransactionRedeemed } = require('./ticket-db');
  ...
  try {
    ...
    return res.status(200).send(`
      ...
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Ticket Validation - ${eventName || 'Bosses & Bowling'}</title>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>${eventName || 'Bosses & Bowling'}</h1>
