/**
 * DynamoDB Schema for Strike After Dark Events Table
 * Stores event information and availability
 */

module.exports = {
  tableName: process.env.EVENTS_TABLE || 'StrikeAfterDark-Events-prod',
  ...
  example: {
    ...
    location: 'Strike After Dark Farm, Address TBD',
    duration_minutes: 90,
