// Strike After Dark Harvest Experience - Frontend JavaScript
...
if (window.strikeAfterDarkInitialized) {
    console.warn('App already initialized');
} else {
    window.strikeAfterDarkInitialized = true;
...
function updateEventDateDisplay() {
    ...
    const eventTime = eventName && eventName.includes('Bosses & Bowling') ? '9:00 AM - 11:00 AM EST' : '8:00 AM - 10:00 AM EST';
