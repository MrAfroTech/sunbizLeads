...
async function run() {
  try {
    console.log('\n=== Add "test task" to Product Launch sprint ===\n');
    ...
    console.log('Finding or creating Product Launch sprint...');
    ...
    console.log('Adding task to Product Launch sprint...');
    await addIssuesToSprint(sprintId, [taskKey]);
    console.log(`✓ Added ${taskKey} to Product Launch sprint.\n`);
