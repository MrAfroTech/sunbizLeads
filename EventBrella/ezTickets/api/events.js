...
const DEFAULT_ORGANIZER = process.env.ORGANIZER_NAME || 'CLIENT_ORGANIZER_NAME';
const DEFAULT_VENUE = process.env.CLIENT_VENUE_NAME || 'CLIENT_VENUE_NAME';
