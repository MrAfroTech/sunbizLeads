...
module.exports = {
  tableName: process.env.EVENTS_TABLE || 'CLIENT_EVENTS_TABLE',
  ...
  example: {
    ...
    location: process.env.CLIENT_ADDRESS_LINE1 && process.env.CLIENT_ADDRESS_LINE2 ? `${process.env.CLIENT_ADDRESS_LINE1}, ${process.env.CLIENT_ADDRESS_LINE2}` : 'CLIENT_ADDRESS_LINE1, CLIENT_ADDRESS_LINE2',
    duration_minutes: 90,
